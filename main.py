...
def main():
    ...
    if choice == "Home":
        st.subheader("Home")
        st.success("18CSE303J DBMS Course Mini Project")
        st.write("Dhruv Limbani - RA2011027010068")
        st.write("Abhishek Barhate - RA2011027010069")
        st.write("Daketi Yatin - RA2011027010084")
